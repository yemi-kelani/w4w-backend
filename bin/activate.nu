...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/yemikelani/Projects/CS 394/wait-4-what-backend'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/yemikelani/Projects/CS 394/wait-4-what-backend/bin/deactivate.nu'
